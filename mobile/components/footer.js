				...
				<View>
					<View style={styles.container}>
						...
						<TouchableOpacity style={styles.container1}>
							<View style={styles.cir}>
								<Appbar.Action icon="alert-circle-outline" onPress={{}} style={styles.icon1} />
							</View>
						...
						<TouchableOpacity style={styles.container1}>
							<View style={styles.cir}>
								<Appbar.Action icon="email-outline" onPress={{}} style={styles.icon1} />
							</View>
						...
						<TouchableOpacity style={styles.container1}>
							<View style={styles.cir}>
								<Appbar.Action icon="phone-outline" onPress={{}} style={styles.icon1} />
							</View>
					...
					<View>
						<List.Section style={styles.list}>
							<List.Accordion title="Electronics">
							...
							<List.Accordion title="Fashion" onPress={handlePress}>
								<TouchableOpacity onPress={handlePress}>
							...
							<List.Accordion title="Beauty" onPress={handlePress}>
								<TouchableOpacity onPress={handlePress}>
							...
							<List.Accordion title="Home & Kitchen" onPress={handlePress}>
								<TouchableOpacity onPress={handlePress}>
					...
					<View style={styles.container3}>
						...
						<View style={styles.container4}>
							<svg
								...
								/>
								<path
									d="M34.4049 8.8H33.9396V5.644H32.9244V5.2H35.4443V5.644H34.4049V8.8Z"
									fill="white"
									stroke="white"
									stroke-width="0.2"
								/>
								<path
									d="M37.2209 8.8V5.2H37.6862V8.8H37.2209Z"
									fill="white"
									stroke="white"
									stroke-width="0.2"
								/>
								<path
									d="M39.7528 8.8H39.2875V5.644H38.2723V5.2H40.762V5.644H39.7528V8.8Z"
									fill="white"
									stroke="white"
									stroke-width="0.2"
								/>
							...
							<Image source={require("./../assets/Huawei-icon.png")} style={styles.image} />
						</View>
						<Text style={styles.texthero2}>CONNECT WITH US</Text>
						<View style={styles.container4}>
							<Appbar.Action icon="facebook" onPress={{}} style={styles.icon} />
							<Appbar.Action icon="instagram" onPress={{}} style={styles.icon} />
							<Appbar.Action icon="linkedin" onPress={{}} style={styles.icon} />
							<Appbar.Action icon="twitter" onPress={{}} style={styles.icon} />
						</View>
						<Text style={styles.tRights}>2024 noon. All Rights Reserved</Text>
						<View style={styles.container4}>
							<Image source={require("./../assets/card-mastercard.svg")} style={styles.carts} />
							<Image source={require("./../assets/card-visa.svg")} style={styles.carts} />
							<Image source={require("../assets/valu.svg")} style={styles.carts} />
							<Image source={require("./../assets/card-amex.svg")} style={styles.carts} />
							<Image source={require("./../assets/cod-en.svg")} style={styles.carts} />
						</View>
						<View style={styles.container4}>
							<TouchableOpacity onPress={handlePress}>
