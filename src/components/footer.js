...
const imgIcons = [{ src: "icon1.svg", alt: "img1" }, { src: "icon2.svg", alt: "img1" }, { src: "icon3.svg", alt: "img1" }, { src: "cod-en.svg", alt: "img1" }];
                    ...
                    <div className="w-full mx-auto py-6 px-5 items-center  md:flex md:w-full sm:w-full ">
                        <div className="w-1/2 flex clg-w-96 sm:flex-1 sm:w-full justify-center sm:justify-between">
                            ...
                            <div className="flex justify-center gap-8">
                                {imgIcons.map((item) => (
                                    <Image src={item.src} width={41} height={26} alt={item.alt} />
                                ))}
                            </div>
                        </div>
                    </div>
