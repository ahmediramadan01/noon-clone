...
const footerIcons =
    [{
        title: "HELP Center", icon: <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="30" height="30" viewBox="0 0 50 50">
            <path d="M 25 2 C 12.309295 2 2 12.309295 2 25 C 2 37.690705 12.309295 48 25 48 C 37.690705 48 48 37.690705 48 25 C 48 12.309295 37.690705 2 25 2 z M 25 4 C 36.609824 4 46 13.390176 46 25 C 46 36.609824 36.609824 46 25 46 C 13.390176 46 4 36.609824 4 25 C 4 13.390176 13.390176 4 25 4 z M 25 11 A 3 3 0 0 0 22 14 A 3 3 0 0 0 25 17 A 3 3 0 0 0 28 14 A 3 3 0 0 0 25 11 z M 21 21 L 21 23 L 22 23 L 23 23 L 23 36 L 22 36 L 21 36 L 21 38 L 22 38 L 23 38 L 27 38 L 28 38 L 29 38 L 29 36 L 28 36 L 27 36 L 27 21 L 26 21 L 22 21 L 21 21 z"></path>
        </svg>, email: "Help.Noon.com"
    }
        , {
        title: "Email Support", icon: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"><title id="title">email_support</title><path d="M5.625 6H18.625C19.5188 6 20.25 6.73125 20.25 7.625V17.375C20.25 18.2688 19.5188 19 18.625 19H5.625C4.73125 19 4 18.2688 4 17.375V7.625C4 6.73125 4.73125 6 5.625 6Z" stroke="#404553" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path><path d="M20.25 7.62501L12.125 13.3125L4 7.62501" stroke="#404553" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path></svg>, email: "egypt@Noon.com"
    },
    { title: "PHONE SUPPORT", icon: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"><title id="title">phone_support</title><path d="M18.1912 14.2183C17.5384 13.5738 16.7234 13.5738 16.0748 14.2183C15.58 14.7089 15.0852 15.1996 14.5987 15.6985C14.4656 15.8358 14.3534 15.8649 14.1912 15.7734C13.871 15.5988 13.5301 15.4574 13.2224 15.2661C11.7879 14.3638 10.5862 13.2037 9.52176 11.8981C8.99369 11.2495 8.52384 10.5551 8.19535 9.77339C8.12883 9.61538 8.1413 9.51143 8.2702 9.38253C8.765 8.90436 9.24733 8.41372 9.73382 7.92308C10.4116 7.24116 10.4116 6.44283 9.72966 5.75675C9.34296 5.3659 8.95627 4.98337 8.56957 4.59251C8.17041 4.19335 7.7754 3.79002 7.37207 3.39501C6.71926 2.75883 5.90429 2.75883 5.25565 3.39917C4.75668 3.88981 4.27851 4.39293 3.77124 4.87526C3.30138 5.32016 3.06438 5.86486 3.01448 6.50104C2.93548 7.53638 3.18912 8.51351 3.54671 9.46569C4.27851 11.4366 5.39286 13.1871 6.74421 14.7921C8.56957 16.9626 10.7484 18.6798 13.2972 19.9189C14.4448 20.4761 15.634 20.9044 16.9272 20.975C17.817 21.0249 18.5904 20.8004 19.2099 20.106C19.634 19.632 20.1122 19.1996 20.5613 18.7464C21.2265 18.0728 21.2307 17.2578 20.5696 16.5925C19.7796 15.7983 18.9854 15.0083 18.1912 14.2183Z" stroke="#404553" stroke-width="1.5"></path></svg>, email: "16358" }]
            ...
            {items.map((item, index) => (
                <>
                    <div className="flex flex-row rounded-ful  gap- p-2 hover:opacity-[0.6] ">
                        ...
                        <div class="flex flex-col rounded-l-lg pl-2   text-slate-950 ">
    ...
    return (
        <>
            <div className="md:col-span-1 ">
                ...
                {items.map((item, index) => (
                    <p key={index} className="text-sm pb-3 text-[#404553] cursor-pointer">{item}</p>
                ))}
            </div>
        </>
    );
            ...
            <footer className="bg-white-900 text-black p-5">
                ...
                <div className="">
                    ...
                    <div className="grid sm:grid-cols-3  md:grid-cols-6 xl:gap-8 lg:gap-6 p-5 md:gap-2 sm:gap-3">
                        <div className="md:col-span-1 ">
                            <FooterColumn title="Electronics" items={["Mobiles", "Laptops", "Cameras", "Televisone", "HeadPhones", "Videpo Games"]} />
                        </div>
                        <div className="md:col-span-1">
                            <FooterColumn title="FASHION" items={["Women's Fashion", "Men's Fashion", "Girl's Fashion", "Women's Watches", "Home Appliances Tools", "Home Improvement", "EyaWear", "Bags & Luggags"]} />
                        </div>
                        <div className="md:col-span-1">
                            <FooterColumn title="HOME AND KITCHEN" items={["Beding", "Path", "Home Appliances Tools", "Home Improvement", , "Home And Decor"]} />
                        </div>
                        <div className="md:col-span-1">
                            <FooterColumn title="BEAUTY" items={["Women's Fragrance", "Men's Fragrance", "Make-Up", "Haircare"]} />
                        </div>
                        <div className="md:col-span-1">
                            <FooterColumn title="KIDS & BABY TOYS" items={["Strollers", "Car Seats", "Baby Clothing", "Feeding", "Bathing & Skincare"]} />
                        </div>
                        <div className="md:col-span-1">
                            <FooterColumn title="TOP BRADS" items={["Apple", "Samsung", "Nike", "Ray-Ban", "Tefal", "L'Oreal Paris"]} />
                        </div>
                    </div>
                </div>
                    ...
                    <div className="flex flex-col justify-center w-full md:w-1/2 mt-4 md:mt-0">
                        ...
                        <div className="flex justify-center gap-3 sm:gap-7">
                            {svgSocialIcons.map((item, index) => (
                                <div key={index} className="w-11 h-11 hover:opacity-[0.7] cursor-pointer" >{item}</div>
                            ))}
                        </div>
                    </div>
                </div>
