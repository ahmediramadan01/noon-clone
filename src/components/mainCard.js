                ...
                <div className="basis-1/4">
                    ...
                    <Card className="lg:w-60 md:w-40 sm:w-30 max-w-[26rem] shadow-lg ms-3 mt-2 rounded-none">
                        ...
                        <CardFooter className="pt-1">
                            ...
                            <div className="pt-3 flex flex-col lg:flex-row sm:flex-row items-center justify-center lg:justify-between">
                                <button
                                    className="select-none rounded bg-blue-500 py-2 px-1 sm:px-2 xm:px-2 lg:px-5  text-center align-middle font-sans text-xs lg:text-sm font-bold uppercase text-white shadow-md shadow-blue-500/20 transition-all hover:shadow-lg hover:shadow-blue-500/40 focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none mb-2 sm:mb-0"
                                    type="button"
                                >
                                    ADD TO CART
                                </button>
                ...
                <div className="basis-1/4">
                    <Card className="lg:w-60 md:w-40 sm:w-30 max-w-[26rem] shadow-lg ms-3 mt-2 rounded-none ">
                        ...
                        <CardBody>
                            ...
                            <p>
                                EGP <span className="font-bold  text-lg">38,700</span> <span className="line-through">40,999</span>{" "}
                                <span className="text-xs">Only 2 days left In stock</span>
                            </p>
