    ...
    return (<>
        <div className="container  bg-blue-gray-50">
            <div className="flex ">
                <div className="lg:basis-1/6 md:basis-1/5  flex-col ">
                    <Card className=" h-full w-full max-w-[20rem] p-4 shadow-none rounded-none  hidden lg:flex flex-col">
                            ...
                            <div className="relative">
                                <Link href={"#"}>
                                    <ListItem className="flex items-center group">
                                        ...
                                        QR Code
                                        <ArrowRightIcon strokeWidth={2} className="h-4 w-4 absolute right-0 top-1/2 transform -translate-y-1/2 opacity-0 transition-opacity duration-300 group-hover:opacity-100" />
                                    </ListItem>
                                </Link>
                            </div>
                            <div className="relative">
                            ...
                            <div className="relative">
                                <Link href={"#"}>
                                    <ListItem className="flex items-center group">
                                        <ListItemPrefix>
                                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M2.28947 4.16965C2.28849 3.13343 3.12824 2.29288 4.16447 2.29288H15.8371C16.8728 2.29288 17.7123 3.13261 17.7121 4.16831L17.7095 15.835C17.7092 16.8703 16.8698 17.7096 15.8345 17.7096H4.17546C3.14062 17.7096 2.30144 16.8712 2.30046 15.8363L2.28947 4.16965Z" stroke="#404553" strokeWidth="1.25" />
                                                <mask id="path-2-inside-1_3553_16769" fill="white">
                                                    <path fillRule="evenodd" clipRule="evenodd" d="M7.49084 13.2725C7.49254 13.2725 7.49424 13.2725 7.49594 13.2725H10.0039C12.3047 13.2725 14.1698 11.4073 14.1698 9.10657C14.1692 6.80372 12.3031 4.93823 10.0015 4.93823H7.5015" />
                                                </mask>
                                                <path fillRule="evenodd" clipRule="evenodd" d="M7.49084 13.2725C7.49254 13.2725 7.49424 13.2725 7.49594 13.2725H10.0039C12.3047 13.2725 14.1698 11.4073 14.1698 9.10657C14.1692 6.80372 12.3031 4.93823 10.0015 4.93823H7.5015" fill="#FEEE00" />
                                                <path d="M10.0039 13.2725V12.0225V13.2725ZM14.1698 9.10657L15.4198 9.10621V9.10657H14.1698ZM7.49238 12.0225C7.49357 12.0225 7.49476 12.0225 7.49594 12.0225V14.5225C7.49373 14.5225 7.49152 14.5225 7.48931 14.5225L7.49238 12.0225ZM7.49594 12.0225H10.0039V14.5225H7.49594V12.0225ZM10.0039 12.0225C11.6143 12.0225 12.9198 10.717 12.9198 9.10657H15.4198C15.4198 12.0977 12.9951 14.5225 10.0039 14.5225V12.0225ZM12.9198 9.10694C12.9194 7.49406 11.6127 6.18823 10.0015 6.18823V3.68823C12.9936 3.68823 15.419 6.11337 15.4198 9.10621L12.9198 9.10694ZM10.0015 6.18823H7.5015V3.68823H10.0015V6.18823Z" fill="#404553" mask="url(#path-2-inside-1_3553_16769)" />
                            ...
                            <div className="relative">
                                <Link href={"#"}>
                                    <ListItem className="flex items-center group">
                                        <ListItemPrefix>
                                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M2.18168 4.16965C2.1807 3.13343 3.02045 2.29288 4.05668 2.29288H17.6047L17.6017 15.835C17.6014 16.8703 16.762 17.7096 15.7267 17.7096H4.06767C3.03283 17.7096 2.19365 16.8712 2.19267 15.8363L2.18168 4.16965Z" stroke="#404553" strokeWidth="1.25" />
                                                <path fillRule="evenodd" clipRule="evenodd" d="M11.7859 12.3955C12.1627 12.0186 12.3958 11.4978 12.3958 10.9227C12.3958 9.7721 11.4631 8.83936 10.3125 8.83936C9.16187 8.83936 8.22913 9.7721 8.22913 10.9227C8.22913 11.4797 8.44774 11.9857 8.80385 12.3595L10.3102 14.1928L11.7859 12.3955Z" fill="#404553" />
                                                <path d="M11.7859 12.3955L11.3439 11.9537L11.3223 11.9753L11.3029 11.9989L11.7859 12.3955ZM8.80385 12.3595L9.28676 11.9627L9.27219 11.945L9.25637 11.9284L8.80385 12.3595ZM10.3102 14.1928L9.82725 14.5896L10.3103 15.1775L10.7932 14.5894L10.3102 14.1928ZM12.2279 12.8374C12.7171 12.348 13.0208 11.6702 13.0208 10.9227H11.7708C11.7708 11.3255 11.6083 11.6891 11.3439 11.9537L12.2279 12.8374ZM13.0208 10.9227C13.0208 9.42692 11.8082 8.21436 10.3125 8.21436V9.46436C11.1179 9.46436 11.7708 10.1173 11.7708 10.9227H13.0208ZM10.3125 8.21436C8.81669 8.21436 7.60413 9.42692 7.60413 10.9227H8.85413C8.85413 10.1173 9.50704 9.46436 10.3125 9.46436V8.21436ZM7.60413 10.9227C7.60413 11.6466 7.88894 12.3052 8.35134 12.7906L9.25637 11.9284C9.00655 11.6662 8.85413 11.3129 8.85413 10.9227H7.60413ZM10.7931 13.796L9.28676 11.9627L8.32095 12.7563L9.82725 14.5896L10.7931 13.796ZM11.3029 11.9989L9.82712 13.7962L10.7932 14.5894L12.2689 12.7922L11.3029 11.9989Z" fill="#404553" />
                                                <path fillRule="evenodd" clipRule="evenodd" d="M10.3124 12.1724C11.0027 12.1724 11.5624 11.6127 11.5624 10.9224C11.5624 10.232 11.0027 9.67236 10.3124 9.67236C9.62202 9.67236 9.06238 10.232 9.06238 10.9224C9.06238 11.6127 9.62202 12.1724 10.3124 12.1724Z" fill="white" />
                                                <path d="M2.18937 4.79836C2.18503 3.41595 3.30449 2.29297 4.68691 2.29297H17.6046L17.6018 6.04297H3.4379C2.74989 6.04297 2.19154 5.48637 2.18937 4.79836Z" fill="#FEEE00" stroke="#404553" strokeWidth="1.25" />
                                            </svg>
                            ...
                            <div className="relative">
                                <Link href={"#"}>
                                    <ListItem className="flex items-center group">
                                        <ListItemPrefix>
                                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M2.28959 4.16965C2.28861 3.13343 3.12836 2.29288 4.16459 2.29288H15.8372C16.8729 2.29288 17.7125 3.13261 17.7122 4.16831L17.7096 15.835C17.7094 16.8703 16.87 17.7096 15.8346 17.7096H4.17558C3.14074 17.7096 2.30156 16.8712 2.30058 15.8363L2.28959 4.16965Z" stroke="#404553" strokeWidth="1.25" />
                                                <path d="M2.29523 8.13185C2.29207 7.20915 3.03918 6.45947 3.96189 6.45947H16.0444C16.9654 6.45947 17.7118 7.2065 17.711 8.12751C17.7103 9.04745 16.9643 9.79281 16.0444 9.79281H3.96189C3.04364 9.79281 2.29838 9.05009 2.29523 8.13185Z" fill="#FEEE00" stroke="#404553" strokeWidth="1.25" />
                                                <mask id="path-3-inside-1_3246_15983" fill="white">
                                                    <path fillRule="evenodd" clipRule="evenodd" d="M5.00368 13.9673C4.9993 13.6191 5.28038 13.3345 5.62863 13.3345L10.2111 13.3345C10.557 13.3345 10.8371 13.6154 10.8361 13.9614C10.835 14.3058 10.5555 14.5845 10.2111 14.5845H5.62863C5.28651 14.5845 5.00798 14.3094 5.00368 13.9673Z" />
                                                </mask>
                                                <path d="M5.62863 14.5845H10.2111V12.0845H5.62863V14.5845ZM10.2111 13.3345H5.62863V15.8345H10.2111V13.3345ZM5.62863 13.3345C5.97075 13.3345 6.24928 13.6095 6.25358 13.9516L3.75378 13.983C3.76667 15.0093 4.60228 15.8345 5.62863 15.8345V13.3345ZM9.58607 13.9576C9.58711 13.6131 9.86663 13.3345 10.2111 13.3345V15.8345C11.2444 15.8345 12.0829 14.9985 12.0861 13.9651L9.58607 13.9576ZM10.2111 14.5845C9.86515 14.5845 9.58503 14.3035 9.58607 13.9576L12.0861 13.9651C12.0892 12.9274 11.2488 12.0845 10.2111 12.0845V14.5845ZM5.62863 12.0845C4.58388 12.0845 3.74065 12.9384 3.75378 13.983L6.25358 13.9516C6.25796 14.2998 5.97688 14.5845 5.62863 14.5845V12.0845Z" fill="#404553" mask="url(#path-3-inside-1_3246_15983)" />
                                            </svg>
                                    ...
                                    <ListItem className="flex items-center group">
                                        <ListItemPrefix>
                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M17.7045 8.17338C17.7045 6.66042 17.1034 5.20942 16.0336 4.1396C14.9638 3.06977 13.5128 2.46875 11.9998 2.46875C10.4869 2.46875 9.03586 3.06977 7.96604 4.1396C6.89621 5.20942 6.29519 6.66042 6.29519 8.17338C6.29519 12.3292 5.18305 14.6314 4.34767 15.7745C4.11416 16.0941 4.36822 16.7303 4.76398 16.7303H19.2357C19.6314 16.7303 19.8855 16.0941 19.652 15.7745C18.8166 14.6314 17.7045 12.3292 17.7045 8.17338Z" stroke="#404553" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                                <path d="M11.9999 20.1074C13.5962 20.1074 14.8903 18.5955 14.8903 16.7305H9.10938C9.10938 18.5955 10.4035 20.1074 11.9999 20.1074Z" fill="#FEEE00" stroke="#404553" strokeWidth="1.5" />
                                            </svg>
                        ...
                        <hr></hr>
                        <Link href={"#"} className="ms-3">Sign out</Link>
                    </Card>
                        ...
                        <div className="block md:col-span-12">
                            <div className="md:flex md:flex-wrap mt-4">
                                <div className="block w-full md:w-1/3 md:pr-4">
                                    ...
                                    <br />
                                    <input type="text" className="w-10/12 h-10 border-2 border-gray-200 mt-2 rounded-lg md:ms-4" placeholder="Email" id="email1" />
                                </div>
                                <div className="block w-full md:w-1/3 md:pr-4">
                                    <label className="md:ms-4 text-sm">First name</label>
                                    <br />
                                    <input type="text" className="w-10/12 h-10 border-2 border-gray-200 mt-2 rounded-lg md:ms-4" placeholder="First name" id="first-name" />
                                </div>
                                <div className="block w-full md:w-1/3">
                                    <label className="md:ms-4 text-sm">Last name</label>
                                    <br />
                                    <input type="text" className="w-10/12 h-10 border-2 border-gray-200 mt-2 rounded-lg md:ms-4" placeholder="Last name" id="last-name" />
                                </div>
                            </div>
                            <div className="md:flex md:flex-wrap mt-4">
                                <div className="block w-full md:w-1/3 md:pr-4">
                                    ...
                                    <br />
                                    <input type="number" className="w-10/12 h-10 border-2 border-gray-200 mt-2 rounded-lg md:ms-4" placeholder="phone" id="email1" /><br />
                                ...
                                <div className="block w-full md:w-1/3 md:pr-4">
                                    ...
                                    <br />
                                    <input type="date" className="w-10/12 h-10 border-2 border-gray-200 mt-2 rounded-lg md:ms-4" placeholder="Birthdate" id="first-name" /><br />
                                    ...
                                    <div className="flex ">
                                        ...
                                        <Button variant="text" className="rounded-full ms-3 bg-pink-200 flex md:w-1/2 lg:w-28">
                                            ...
                                            <svg width="9" height="18" viewBox="0 0 9 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path id="Vector" d="M4.5 0C5.03043 0 5.53914 0.210714 5.91421 0.585786C6.28929 0.960859 6.5 1.46957 6.5 2C6.5 2.53043 6.28929 3.03914 5.91421 3.41421C5.53914 3.78929 5.03043 4 4.5 4C3.96957 4 3.46086 3.78929 3.08579 3.41421C2.71071 3.03914 2.5 2.53043 2.5 2C2.5 1.46957 2.71071 0.960859 3.08579 0.585786C3.46086 0.210714 3.96957 0 4.5 0ZM3 18V14H0L2.59 6.41C2.84 5.59 3.6 5 4.5 5C5.4 5 6.16 5.59 6.41 6.41L9 14H6V18H3Z" fill="#D72B66" />
                                            </svg>
                            ...
                            <Button className="mt-8 ms-4 bg-blue-800 lg:w-60 md:w-60 mb-4 sm:w-3/4" disabled>Update Profile</Button>
            ...
            <div className="flex h-12 w-full bg-white">
                ...
                <Link href={"#"} className="mt-2 ms-32 text-gray-700 text-xs hover:underline w-1/6 ">Help Center Articles</Link>
                <Link href={"#"} className="mt-2 text-gray-700 text-xs hover:underline w-1/6">Warranty policy</Link>
                <Link href={"#"} className="mt-2  text-gray-700 text-xs hover:underline w-1/6">Return policy</Link>
                <Link href={"#"} className="mt-2  text-gray-700 text-xs hover:underline w-1/6">Terms of use</Link>
                <Link href={"#"} className="mt-2  text-gray-700 text-xs hover:underline w-1/6">Terms of sale</Link>
                <Link href={"#"} className="mt-2  text-gray-700 text-xs hover:underline w-1/6">Privacy policy</Link>
