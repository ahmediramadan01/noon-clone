                                ...
                                <div className="w-full">
                                    <div className="flex flex-wrap items-start mt-4">
                                        ...
                                        <div className="w-full lg:w-1/4 md:w-1/4 sm:w-1/4">
                                            <button className="rounded-full bg-blue-700 ms-2 mt-2 text-white w-full lg:w-24 md:w-24">Default</button>
                                        </div>

                                        <div className="w-full lg:w-1/4 md:w-1/4 sm:w-1/4">
                                            <button className="rounded-full ms-4 lg:ms-auto mt-2 lg:mt-2 md:mt-2 border-2 border-black-50 text-black w-full lg:w-24 md:w-24 flex" onClick={handleOpenshare}>
                                        ...
                                        <div className="w-full lg:w-1/4 md:w-1/4 sm:w-full">
                                            <button className="rounded-full ms-2  mt-2 lg:mt-2 md:mt-2 border-2 border-black-50 text-black w-full lg:w-16 md:w-16 sm:w-16 flex" onClick={toggleOpen}>...More</button>
                                            <Collapse open={open}>
