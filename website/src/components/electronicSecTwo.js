									...
									<div className=" w-[276] h-[167] bg-slate-50">
										<div className="w-[276] h-[27] ">
											<div className="py-[2px]  px-[14px]  text-base w-[154] h-[26] m-3">
												<span
													key={index}
													className="text-white p-1 text-nowrap w-full bg-black rounded-tl-lg rounded-br-lg px-auto mx-auto no-wrap"
												>
													{item.title}
												</span>
											</div>
										</div>
										<div className="mt-4 mb-2 px-3">{item.description}</div>
										<div className="px-3">
