								...
								<div className="w-full ">
									<div className="flex mt-4 ms-4">
										...
										<div className="w-28 ms-auto">
											<button
												className="rounded-full ms-40  border-2 mt-2  border-black-50  text-black w-24 flex"
											...
											<Dialog open={openshare} className="opacity-100" size="sm" handler={handleOpenshare}>
												...
												<DialogBody className=" overflow-scroll">
													...
													<div className="flex">
														...
														>
															<path
																d="M8.91638 4.80921L10.7199 3.0057C11.1146 2.61096 11.5832 2.29784 12.099 2.08421C12.6147 1.87059 13.1675 1.76063 13.7257 1.76063C14.284 1.76063 14.8367 1.87059 15.3525 2.08421C15.8682 2.29784 16.3369 2.61096 16.7316 3.0057C17.1263 3.40043 17.4394 3.86905 17.6531 4.38479C17.8667 4.90054 17.9767 5.45331 17.9767 6.01155C17.9767 6.56978 17.8667 7.12256 17.6531 7.6383C17.4394 8.15405 17.1263 8.62266 16.7316 9.0174L14.9281 10.8209M11.3211 14.4279L9.51755 16.2314C9.12282 16.6262 8.6542 16.9393 8.13845 17.1529C7.62271 17.3665 7.06994 17.4765 6.5117 17.4765C5.38429 17.4765 4.30305 17.0286 3.50585 16.2314C2.70865 15.4342 2.26079 14.353 2.26079 13.2256C2.26079 12.0982 2.70865 11.0169 3.50585 10.2197L5.30936 8.41623"
																stroke="#3866DF"
																stroke-width="1.5"
															...
															/>
															<path
																d="M7.71484 12.0225L12.5242 7.2131"
																stroke="#3866DF"
																stroke-width="1.5"
																stroke-linecap="round"
																stroke-linejoin="round"
													...
													<div className="flex">
														...
														>
															<path
																d="M4.59209 4.59277H19.4069C20.4254 4.59277 21.2588 5.42611 21.2588 6.44463V17.5557C21.2588 18.5743 20.4254 19.4076 19.4069 19.4076H4.59209C3.57357 19.4076 2.74023 18.5743 2.74023 17.5557V6.44463C2.74023 5.42611 3.57357 4.59277 4.59209 4.59277Z"
																stroke="#3866DF"
																stroke-width="1.5"
																stroke-linecap="round"
																stroke-linejoin="round"
															/>
															<path
																d="M21.2588 6.44434L11.9995 12.9258L2.74023 6.44434"
																stroke="#3866DF"
																stroke-width="1.5"
																stroke-linecap="round"
																stroke-linejoin="round"
										...
										<div className=" h-28 ms-auto">
											<button
												className="rounded-full mt-2  border-2 bg-gray-100  absolute right-20   border-black-50  text-black w-24"
												onClick={toggleOpen}
											>
												...More
											</button>
										...
										<Card className="lg:w-60 md:w-40 sm:w-20 max-w-[26rem] shadow-lg ms-3 mt-2 ">
											...
											<CardFooter className="pt-1">
												...
												<div className="pt-3">
													...
													<button className="ms-3 w-10 py-1 px-3 text-center align-middle text-blue-600 rounded border-2 border-blue-500">
														...
													</button>
												</div>
											</CardFooter>
