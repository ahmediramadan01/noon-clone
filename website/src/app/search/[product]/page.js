...
export default function SearchPage({ params }) {
    ...
    const filteredProducts = products.filter((product) => {
        ...
        const priceFilter = (!minPrice || parseInt(product.price) >= parseInt(minPrice)) &&
                            ...
                            >
                                ...
                                <AccordionBody className="py-2 ">
                                    <List className="p-0 ">
                                        <div className="flex">
                                            <Checkbox color="blue" />
                                            <svg width="60" height="20" viewBox="0 0 82 22" fill="none" xmlns="http://www.w3.org/2000/svg " className="mt-4">
                                                <path
                            ...
                            >
                                ...
                                <AccordionBody className="py-2 ">
                                    <List className="p-0 block ">
                                        ...
                                        <div className="flex justify-between">
                                            <Link href={"#"} className="mt-3 ms-4 hover:text-blue-700 ">Stationery</Link>
                                            <Checkbox color="blue"
                                ...
                                <AccordionBody className="py-2 ">
                                    <List className="p-0 ">
                                        <div className="block">
                                            ...
                                            <div className="text-xs ms-3 text-gray-500 ">1.1 Star <span className="ms-48">5stars</span></div>
